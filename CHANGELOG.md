...
## [7.4.0](https://github.com/ubiquity-os/ubiquity-os-kernel/compare/v7.3.0...v7.4.0) (2026-04-21)


### Features

* add comment context with semantic matches ([e9f7911](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/e9f7911b30c20f635337cc8e1a4016fc06718e22))
* add conversation context retention ([38d3515](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/38d3515df187a3e6db9548838b94b1dcd2365071))
* add conversation graph cli ([e416d44](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/e416d447cde5334e497e0ae2d7e64786f5baccbb))
* add Deno dashboard logs fetching capabilities and related scripts ([cc4bca4](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/cc4bca45884e50bdd35a5c890422caf9bf6fd258))
* clarify conversation graph output ([b64e517](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/b64e51757f65e57ae0107715b04c9c6fc06a976a))
* deploy ignore ([d802c04](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/d802c041672cf580f34eb8fc4decae97c6c41bda))
* enable graph output by default ([2927fe0](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/2927fe08cbb5530f4eb38ae8ae195d3e6d8da3ab))
* enhance GitHub context handling and improve ESLint configuration ([d6e912b](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/d6e912b9b0f6453f386d6bd889e659aa38be247d))
* expand similarity across graph documents ([26a2852](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/26a2852047b941a8cf40e2517512bea0fcf2884a))
* finalize conversation graph context ([770e612](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/770e612b67deedfa0c8a0d377148e4da1c16f4d1))
* improve conversation graph context ([6aef557](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/6aef55751229f86ae9096dfaa1273029b114d7ba))
* **kernel:** emit hotfix error events ([61556ce](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/61556ce7823bfe9e9d00aa224a1ed257515fed38))
* load env for graph cli ([652a72e](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/652a72e069b215920d5332d1186215a2f6bc66d7))
* merge codex refactor into development ([eb65a19](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/eb65a1975df886136eac649506bbde8bcb0e729a))
* randomized descriptive messages describing when the llm provider is having problems ([b857c9b](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/b857c9b8ea42576dedc164841869c5ffbc68989d))
* show semantic metadata in graph cli ([b07501c](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/b07501c714f3c34f207d02a29c1bc1bf698b393a))
* support env-specific config imports ([c258da9](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/c258da9ff47f0fb1ba3e857f51b60e8eb36ed7d6))


### Bug Fixes

* address review feedback ([42ff83f](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/42ff83f6df6949695c0a71abb4b77ea0b0c90ccc))
* address review feedback ([5268b0f](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/5268b0fe84aafe6ad64d157366a51e632e308865))
* address review feedback ([21b4dae](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/21b4daed5ef3a99a9f296653319941ef6f3a0673))
* address review feedback ([9ccfd11](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/9ccfd11fdf758cc8981811303580ec37fcd56c49))
* align kernel deploy workflow with deno-deploy inputs ([41732df](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/41732dfc326ffce2664021f4e4cb190f5a9fb702))
* align typebox with plugin-sdk ([3fec5ef](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/3fec5eff1a8fa699b8d5768d9c88f011c06021d9))
* align versions and env defaults ([81de2eb](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/81de2ebefb64a38b652d654a9424576855ad65f6))
* allow digits in slash commands ([4b75bdf](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/4b75bdf829c30df30078772d6c84380a687262e9))
* allow prettier check writes ([4fc0436](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/4fc04365fab4a79b485116d7043fb7e9d80e3f7d))
* avoid double prefixing X-Hub-Signature-256 ([ae03c68](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/ae03c688ace62759b646ab748cfe28b937837f2e))
* ci ([e3b5397](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/e3b5397b7e4d351a6affda901bf36458ab40118b))
* **ci:** align deploy entrypoint and formatter scope ([ba431c8](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/ba431c81ffc621b390856f2e7446df4fcf803541))
* **ci:** init plugin-sdk submodule for deploy ([af5e2fb](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/af5e2fb3874c857f331eb1b2a428cac2175d0f56))
* **ci:** use npm plugin-sdk imports ([164f69d](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/164f69d5a2b414e9952b822631d3aaefc36b9665))
* delegate config manifest lookup to kernel resolver ([95a95ef](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/95a95efcb59fe6e3d634c5b53023bc551514edad))
* delegate config manifest lookup to kernel resolver ([137136f](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/137136f04d3d27a7115da3a39cee90006684ef6c))
* deno deploy project name ([2bf0f13](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/2bf0f13809f78a54fb15ceb6af8038e56882d4f8))
* **deploy:** add explicit ts import extensions ([dee96de](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/dee96debd8d3ebf9a872b57eeb93091ebaa9a90b))
* ensure help command always replies and add logs ([2453bd5](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/2453bd5612710517934c14d5a02bcb25bc10dff8))
* handle null path in pointerStringToSegments ([244bc7b](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/244bc7bb901f29417522fa74c88ab7f34803ab87))
* handle review comments ([628efd0](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/628efd0f97ba9da73e1a116997c7c475d3ac9d84))
* improve agent memory handling and remove redundant logging ([5f89a1a](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/5f89a1a48ed1f19dcac43b571c6ca0429c45f7b1))
* include project_name in Deno Deploy workflow ([ffc5355](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/ffc53557b61f16e188a2b38d36de3debd7ee347f))
* include supabase anon key ([f7162e5](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/f7162e5d0225646085ec6646591a563dbe73b20a))
* infer kernel deploy organization from token ([5243e38](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/5243e3870e99abac2b5f6c95eaf6fe2d344cf2ce))
* **kernel:** dispatch workflows from resolved artifact refs ([0ce2345](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/0ce234576663763df74c34f56a5ad7a657760a51))
* **kernel:** guard manifest fallback logging for sparse test contexts ([e7121f9](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/e7121f908ece7e268b9cca415d20d2b550539f95))
* **kernel:** handle git command failure ([98b3361](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/98b33619ee51702e4e16e4c4302225089b1ef0bd))
* **kernel:** harden artifact manifest fallback behavior ([38dcfbb](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/38dcfbb067c73a9e81fb6199b8498d5f9205bf5f))
* **kernel:** harden manifest fetch and caches ([bff89d5](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/bff89d5bed8e4e75f196fbeb884ef08d4e647b5c))
* **kernel:** harden review replies and vector queries ([094e871](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/094e8717c760652277fc77ca91c41701ea91eacd))
* **kernel:** resolve check failures ([4405533](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/44055331a2eef66a31a633fa36648657813ef012))
* **kernel:** resolve no-ref manifest candidates via default branch ([dd9c15a](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/dd9c15ab3dbad64b6ccb2e8243389147cfe066fa))
* **kernel:** resolve plugin manifests from artifact refs ([5de5f14](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/5de5f14315e74ad029fb8a30618be2b34beefb45))
* **kernel:** resolve plugin manifests from dist artifact refs ([b7a111e](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/b7a111eb9c0ddc565ed535e7b45fdb1fffdb08f2))
* **kernel:** skip runsOn empty plugins ([d2362dd](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/d2362dd8649d6357183053c99b458a2ad7fcded0))
* **kernel:** treat develop and development refs distinctly ([945856d](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/945856d2efc9e450a9b5797285c3bc8b4733d179))
* **kernel:** validate agent env and serialize graph ([975809a](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/975809ae4be708b9eb2569170d573649d152a8b2))
* kv resiliency and mention-help routing ([47e7d68](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/47e7d68ff7f7c2e02faa91e0efca248a5236c5db))
* refactor plugin dispatch logic, add `getWorkerUrlFromManifest`, and update logging ([181b8b9](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/181b8b96b00f63c055abf25a87406053383206e6))
* repair conversation graph linking ([f43e35a](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/f43e35a1a051644fa493610b2dea72f6ca036934))
* require personal agent PAT ([c1438c2](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/c1438c253ec8e6f172804fe10badd9566ecb3713))
* scope workflow run lookup ([02b998e](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/02b998e68cef18940a06a44cb0bb1a08b73825da))
* stop bot-authored comment routing loops ([8df372e](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/8df372e2d58bc2558a00d38fa64b4aaef7712734))
* strip quotes from multiline secrets ([cbac899](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/cbac899b398bfb0cb6684e6bb6153459e279873b))
* trailing sleshed are deleted when fetching manifest.json ([a780293](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/a780293b61eb3747bcc11f52dc34cb113972ec36))
* update `dispatchWorker` to correctly stringify the payload ([aa90e31](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/aa90e312c6c5ef550a639e2673ced3b69dd177e9))
* use installation token for personal agent ([12f0813](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/12f0813d97de5eae55d0100d87df81ec1537906c))
* wrap plugin dispatch in try/catch to prevent execution failures ([3b34704](https://github.com/ubiquity-os/ubiquity-os-kernel/commit/3b3470454095d36c7f56172b204fd758339fd148))
